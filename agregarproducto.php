...
<head>
    ...
    <style>
        ...
        #btn-registrar { background-color: #007BFF; }
        #btn-registrar:hover { background-color: #0056b3; }
   ...
   <h2>IMEI&SN/RENTAS/ACTIVACIONES</h2>
    ...
    <label>Activ / Renov / Rent ingresar Orden sin agregar IMEI </label>
        ...
        <div class="form-group" style="display: flex; align-items: center;">
            ...
            <input type="text" id="imei" name="imei_sn" required maxlength="15"
                   pattern="\d{15}" title="El IMEI debe tener 15 dígitos">
        ...
        <div class="form-group">
            ...
            <select name="servicio" class="select-servicio" required>
                <option disabled selected>Seleccione un servicio...</option>
                 ...
                 <optgroup label="BYPASS BARBON Service">
                    <option value="Bypass PRECIO COVID (10 SOLES)">⚡ Bypass PRECIO COVID (10 SOLES) ⚡</option>
                    <option value="BLOQUEO KG REMOVE ANDROID 15 DEGRADADO A 14 (8.91 USDT)">⚡ BLOQUEO KG REMOVE ANDROID 15 DEGRADADO A 14 (8.91 USDT) ⚡</option>
                 </optgroup>
...
<option value="Lista Blanca Perú — Equipos Bloqueados (42.4 USDT)">⚡ Lista Blanca Perú — Equipos Bloqueados (42.4 USDT) ⚡</option>
...
<!-- ================= END REMOTE SERVICES ===================== -->
        ...
        <div class="submit-buttons">
            <button type="submit" id="btn-registrar">📋 Registrar Dispositivo</button>
           
            <button type="submit" id="btn-guardar">💾 Guardar en Base de Datos</button>
        </div>

    </form>

    <a href="listaactualizada.php">Ver registros</a>

   <form action="vaciar_usuarios.php" method="POST" id="formEliminar"></form>

<a style="cursor:pointer; color: #fff;"
   onclick="document.getElementById('formEliminar').submit();">
   ELIMINAR DATOS DE USUARIOS
</a>


<a href="listaactualizada.php">Registrar Dispositivo Bypass A12+</a>

    
    <a href="lista.php">Ver lista completa</a>
</div>

<script>
// Checkbox para IMEI automático
